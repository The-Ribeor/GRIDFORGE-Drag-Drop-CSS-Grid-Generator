      ...
      <div className="max-w-5xl mx-auto space-y-12">
          ...
          {[ { l: 'HTML', c: htmlCode }, { l: 'CSS', c: cssCode } ].map(b => (
            <div key={b.l} className="flex flex-col space-y-4">
              <div className="flex justify-between items-center px-1">
                ...
                >
                  {copyStatus === b.l ? <Check size={14} /> : <Copy size={14} />} {copyStatus === b.l ? t.copied : t.copy}
                </button>
              </div>
              <div className="bg-[#0F172A] rounded-2xl p-6 border border-slate-700 text-[12px] font-mono text-slate-400 shadow-inner border-l-4 border-l-slate-600">
                <pre className="whitespace-pre-wrap break-all leading-relaxed"><code>{b.c}</code></pre>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-end pt-10 border-t border-slate-800 gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                  ...
                  <span>{t.by}</span>
                  <a href="https://www.theribeor.com" target="_blank" className="text-slate-300 hover:text-white underline decoration-slate-700 underline-offset-4">The Ribeor</a>
          ...
          <div className="flex gap-6 text-slate-500">
             <a href="https://github.com/Diegoberrio1601" target="_blank" className="hover:text-white transition-all transform hover:-translate-y-1"><Github size={20}/></a>
             <a href="https://www.linkedin.com/in/diegoberrio1601/" target="_blank" className="hover:text-white transition-all transform hover:-translate-y-1"><Linkedin size={20}/></a>
             <a href="https://www.instagram.com/theribeor/" target="_blank" className="hover:text-white transition-all transform hover:-translate-y-1"><Instagram size={20}/></a>
          </div>
        </div>
      </div>
    </footer>
