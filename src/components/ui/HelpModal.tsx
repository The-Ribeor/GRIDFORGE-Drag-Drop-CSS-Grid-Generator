      ...
      <div className="bg-[#334155] border border-slate-600 w-full max-w-sm rounded-2xl p-8 shadow-2xl space-y-6 animate-in fade-in zoom-in duration-300" onClick={e => e.stopPropagation()}>
        ...
        <div className="space-y-3 text-[11px] text-slate-300">
          <div className="flex gap-4 items-center bg-slate-800/40 p-4 rounded-xl border border-slate-600/30 hover:border-blue-500/50 transition-colors group">
            <div className="bg-slate-700 p-2 rounded-lg group-hover:bg-blue-600/20 transition-colors"><Plus size={16} className="text-blue-400" /></div>
            <p>{t.step1}</p>
          </div>
          <div className="flex gap-4 items-center bg-slate-800/40 p-4 rounded-xl border border-slate-600/30 hover:border-blue-500/50 transition-colors group">
            <div className="bg-slate-700 p-2 rounded-lg group-hover:bg-blue-600/20 transition-colors"><Move size={16} className="text-blue-400" /></div>
            <p>{t.step2}</p>
          </div>
          <div className="flex gap-4 items-center bg-slate-800/40 p-4 rounded-xl border border-slate-600/30 hover:border-blue-500/50 transition-colors group">
            <div className="bg-slate-700 p-2 rounded-lg group-hover:bg-blue-600/20 transition-colors"><Maximize size={16} className="text-blue-400" /></div>
            <p>{t.step3}</p>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-slate-600/50 flex flex-col gap-4">
          ...
          <button onClick={onClose} className="w-full bg-white text-slate-900 font-black py-4 rounded-xl uppercase text-[11px] tracking-[0.3em] hover:bg-blue-500 hover:text-white transition-all shadow-lg active:scale-[0.98]">
            {t.button}
          </button>
        </div>
      </div>
